...
void VulkanEngine::init_pipelines() {
    ...
    if (!load_shader_module("shaders/triangle.frag.spv",
        ...
        std::cout << "Red Triangle fragment shader succesfully loaded"
                  << std::endl;
    }
    ...
    if (!load_shader_module("shaders/triangle.vert.spv",
        ...
        std::cout << "Red Triangle vertex shader succesfully loaded"
                  << std::endl;
    }
    ...
    if (!load_shader_module("shaders/tri_mesh_pushconstants.vert.spv",
                            &meshVertShader)) {
        std::cout << "Error when building the triangle vertex shader module"
                  << std::endl;
    } else {
